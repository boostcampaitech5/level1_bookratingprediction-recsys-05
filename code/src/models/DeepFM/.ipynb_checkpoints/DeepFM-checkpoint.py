...
class DeepFM(nn.Module):
    ...
    def __init__(self,
        ...
        self.field_dims = list(len(data.field_dims) for k in col_dict)
        ...
        self.dnn_activation = args.dnn_activation
        self.dnn_use_bn= = args.dnn_use_bn
        
        self.embedding = nn.ModuleList([
            nn.Embedding(feature_size, factor_dim) for feature_size in self.field_dims
        ])
        ...
        self.dnn = DNNLayer(input_dim=(self.num_fields * self.factor_dim), 
                            ...
                            activation=sel.fdnn_activation, 
                            dropout_rate=self.dnn_dropout, use_bn=self.dnn_use_bn)
