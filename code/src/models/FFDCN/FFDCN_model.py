...
class FFDCN(nn.Module):
    ...
    def __init__(self, args, data):
        ...
        self.cn = CrossNetwork(self.embed_output_dim, args.DCN_MLP_DIM_LAYERS)
        self.mlp = MultiLayerPerceptron(self.embed_output_dim, args.DCN_MLP_DIMS, args.DCN_DROPOUT, output_layer=False)
        self.cd_linear = nn.Linear(self.mlp_dims[0], 1, bias=False)
